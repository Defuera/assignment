...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  Stream<HomeState> _processInit(Init event) async* {
  ...
  Stream<HomeState> _processOnDailyGoalSet(OnDailyGoalSet event) async* {
  ...
  Stream<HomeState> _processOnSwitchReminderPressed(OnSwitchReminderPressed event) async* {
